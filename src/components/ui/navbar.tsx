...
export const Navbar = ({ children, className }: NavbarProps) => {
  ...
  return (
    <motion.div
      ref={ref}
      className={cn(
        visible ? "fixed inset-x-0 top-0 z-40 w-full" : "sticky inset-x-0 top-20 z-40 w-full",
        className
      )}
    >
...
export const NavBody = ({ children, className, visible }: NavBodyProps) => {
  return (
    <motion.div
      ...
      className={cn(
        "relative z-[60] mx-auto hidden w-full  flex-row items-center justify-between self-start rounded-full  px-4 py-2 lg:flex bg-transparent",
  ...
  return (
    ...
    >
      <img
        ...
        height={30}
      />
      <span className="font-bold text-xl text-orange-400">VibeByte</span>
    </a>
  );
};
